...
|---|---|---|
| Tablet 768 px та laptop 1280 px | Основні контрольні viewport 1440 і 375 пройдені; проміжні breakpoint-и реалізовані, але окремі скриншоти ще не зафіксовані | За потреби виконати додаткову візуальну QA-сесію |
